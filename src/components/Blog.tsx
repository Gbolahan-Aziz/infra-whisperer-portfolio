...
const blogPosts = [
  {
    ...
    url: "https://medium.com/@I_am_zee/improving-your-deep-learning-model-with-transfer-learning-using-tensorflow-hub-a5d299613ae6",
  },
  {
    ...
    url: "https://medium.com/@I_am_zee/scraping-user-information-on-github-using-pygithub-2710dc05319a",
  },
  {
    ...
    url: "https://medium.com/@I_am_zee/crafting-effective-devops-pipelines-3089421b0372",
  },
  {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <FadeInWhenVisible delay={index * 0.3} key={index}>
              <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg bg-card/50 backdrop-blur-sm hover:glow">
